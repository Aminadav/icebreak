-- Database Schema Generated on 2025-06-29T06:23:10.592Z
...
CREATE TABLE IF NOT EXISTS "screen_visits" (
  ...
  CONSTRAINT "screen_visits_game_id_fkey" FOREIGN KEY ("game_id") REFERENCES "games"("game_id"),
  CONSTRAINT "screen_visits_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("user_id")
);
...
CREATE INDEX idx_screen_visits_calc_screen_name ON public.screen_visits USING btree (calc_screen_name);
CREATE INDEX idx_screen_visits_created_at ON public.screen_visits USING btree (created_at);
CREATE INDEX idx_screen_visits_game_user ON public.screen_visits USING btree (game_id, user_id);
CREATE INDEX idx_screen_visits_game_user_screen ON public.screen_visits USING btree (game_id, user_id, calc_screen_name);
