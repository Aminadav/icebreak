-- Database Schema Generated on 2025-06-22T02:21:12.416Z
...
CREATE TABLE IF NOT EXISTS "devices" (
  ...
  "journey_state" CHARACTER VARYING(50) DEFAULT 'INITIAL'::character varying,
  "pending_game_name" TEXT,
  "pending_phone_number" CHARACTER VARYING(20) DEFAULT NULL::character varying,
  "metadata" JSONB,
...
-- Indexes
CREATE INDEX idx_devices_journey_state ON public.devices USING btree (journey_state);
CREATE INDEX idx_devices_pending_phone ON public.devices USING btree (pending_phone_number);
